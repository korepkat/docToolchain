...
inputFiles = [
        [file: 'doc/manual.adoc',       formats: ['html','pdf']],
]
...
changelog.with {
    ...
    cmd = 'git --no-page log --all'
}

//*****************************************************************************************

//Configuration for exportContributors2
...
confluence.with {
    input = [
            [ file: "build/html5/doc/manual.html" ],
    ]
